  ...
  return (
    <div className="flex flex-col items-center gap-[35px] lg:gap-[100px] mb-[28px] lg:mb-[90px]">
      ...
      <div className="flex flex-col items-center gap-[24px] h-[120px]">
        ...
        <a href="https://padlet.com/smdacos/dart-ai-y50vppna1ecppkpm" className="font-inter text-[16px] lg:text-[24px] leading-[28px] text-center text-white hover:scale-105">궁금한 점을 남겨주세요 (click)</a>
